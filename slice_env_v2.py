...
class Slice:
            ...
            if np_action[i] == 0: # in edge cloud
                ...
                if i == 1: # first VNF is in central, d_c = 120m
                    if list_latency[i] - 0.12 <= 0:
                        return 8960, 17920
                    c_temp1 = c / (list_latency[i] - 0.12) * 2
    ...
    def step(self, action, o, data_uRLLC, data_eMBB, data_mMTC, step):
        ...
        capacity_uRLLC = math.log2((pow(10,(20/10))+1)) * 2
        capacity_eMBB = math.log2((pow(10,(12/10))+1)) * 7
        capacity_mMTC = math.log2((pow(10,(-10/10))+1)) * 1
        ...
        #print("latency_point:", latency_point)
        ...
        #print("Error, uRLLC:", error_uRLLC_a, "eMBB:", error_eMBB_a, "mMTC:", error_mMTC_a, "error_point:", error_point)
